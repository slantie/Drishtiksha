# Server/src/ml/architectures/cross_efficient_vit_arch.py
...
from src.ml.dependencies.efficientnet_pytorch.model import EfficientNet
...
class CrossEfficientViT(nn.Module):
    def __init__(
        ...
        *,
        ...
        super().__init__()
        # This part now correctly reads from the nested 'model' key in the config dict
        ...
        sm_enc_depth = model_config['sm-enc-depth']
        sm_enc_heads = model_config['sm-enc-heads']
        sm_enc_mlp_dim = model_config['sm-enc-mlp-dim']
        sm_enc_dim_head = model_config['sm-enc-dim-head']
        lg_patch_size = model_config['lg-patch-size']
        lg_enc_depth = model_config['lg-enc-depth']
        lg_enc_mlp_dim = model_config['lg-enc-mlp-dim']
        lg_enc_heads = model_config['lg-enc-heads']
        lg_enc_dim_head = model_config['lg-enc-dim-head']
        ...
        emb_dropout = model_config['emb-dropout']
