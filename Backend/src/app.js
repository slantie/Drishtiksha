...
if (config.STORAGE_PROVIDER === 'local') {
    ...
    logger.info(`Serving static files from URL '/${staticUrlPath}' mapped to directory '${staticDirPath}'`);
}
...
app.get('/', (req, res) => {
    res.status(200).json({ success: true, message: 'Drishtiksha Backend API is alive and running!' });
});
