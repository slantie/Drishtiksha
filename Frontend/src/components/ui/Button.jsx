...
const buttonVariants = cva(
    "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
    {
        variants: {
            variant: {
                default:
                    "bg-light-highlight dark:bg-dark-highlight text-white shadow hover:bg-light-highlight/90 dark:hover:bg-dark-highlight/90",
                destructive:
                    "bg-red-500/10 text-red-500 shadow-sm hover:bg-red-500/20 dark:bg-red-500/20 dark:hover:bg-red-500/30",
                outline:
                    "border border-light-secondary dark:border-dark-secondary bg-transparent shadow-sm hover:bg-light-hover dark:hover:bg-dark-hover text-light-text dark:text-dark-text",
                secondary:
                    "bg-light-muted-background dark:bg-dark-secondary text-light-text dark:text-dark-text shadow-sm hover:bg-light-hover dark:hover:bg-dark-hover",
